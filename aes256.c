//
// This is an implementation of the AES 256-bit algorithm, specifically CBC mode.
//
...
// For AES-256bit the key size is proportionally larger.
// 
// Currently being maintained by A0zhar!!!!
// ---
// Credits: 
//  - Kokke for the original files:
